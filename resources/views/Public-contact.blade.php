    ...
    <section class="text-gray-600 body-font relative" _msthidden="8">
        <div class="container px-5 py-24 mx-auto" _msthidden="8">
            <div class="flex flex-col text-center w-full mb-12" _msthidden="2">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900" _msttexthash="132405" _msthidden="1"
                    _msthash="2039" data-aos="zoom-in" data-aos-duration="3000">Hubungi Kami</h1>
            </div>
            <div class="lg:w-1/2 md:w-2/3 mx-auto" _msthidden="6">
                <div class="flex flex-wrap -m-2" _msthidden="6">
                    <div class="p-2 w-1/2" _msthidden="1">
                        <div class="relative" _msthidden="1" data-aos="fade-down-right" data-aos-duration="3000">
                            <label for="name" class="leading-7 text-sm text-gray-600" _msttexthash="43069"
                                _msthidden="1" _msthash="2041">Nama</label>
                            <input type="text" id="name" name="name"
                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    </div>
                    <div class="p-2 w-1/2" _msthidden="1">
                        <div class="relative" _msthidden="1" data-aos="fade-down-left" data-aos-duration="3000">
                            <label for="email" class="leading-7 text-sm text-gray-600" _msttexthash="58058"
                                _msthidden="1" _msthash="2042">Email</label>
                            <input type="email" id="email" name="email"
                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    </div>
                    <div class="p-2 w-full" _msthidden="1">
                        <div class="relative" _msthidden="1" data-aos="zoom-out-down" data-aos-duration="3000">
                            <label for="message" class="leading-7 text-sm text-gray-600" _msttexthash="92924"
                                _msthidden="1" _msthash="2043">Pesan</label>
                    ...
                    <div class="p-2 w-full" _msthidden="1">
                        <button
                            class="flex mx-auto text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-lg shadow-[4px_4px_4px_#b1b1b1]"
                            _msttexthash="79859" _msthidden="1" _msthash="2044" data-aos="zoom-in" data-aos-duration="3000">Kirim</button>
                    </div>
                    <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center" _msthidden="2">
                        <a class="text-indigo-500" _msttexthash="327145" _msthidden="1"
                            _msthash="2045">MyBook's@gemail.com</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-screen-lg py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
                <div class="p-5 sm:w-2/12 border-r">
                    ...
                    <ul>
                        ...
                        <li class="my-4 {{ request()->is('contact') ? 'underline underline-offset-8 decoration-4 decoration-blue-500' : '' }}">
                            <a class="font-semibold text-gray-400 hover:underline underline-offset-8 decoration-4 decoration-blue-500" href="/contact">Hubungi</a>
                        </li>
                    </ul>
                </div>
