...
<div class="dash-content">
    <div class="title">
        ...
        <span class="text animate__animated animate__rotateInUpLeft animate__delay-0.5s">Pengembalian Buku</span>
    </div>
...
@endif
    <form action="return-book" method="post">
        ...
        <div class="max-w-2xl mx-auto mt-5">
            ...
            <div class="border border-gray-300 text-gray-600 text-sm bg-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 shadow-[3px_3px_4px_#b1b1b1]"
                data-aos="flip-left" data-aos-duration="3000">
                <select name="user_id" id="user" class="inputBox" style="width: 100%; hight:100%">
        ...
        <div class="max-w-2xl mx-auto mt-12">
            ...
            <div class="border border-gray-300 text-gray-600 bg-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 shadow-[3px_3px_4px_#b1b1b1]"
                data-aos="flip-right" data-aos-duration="3000">
                <select name="book_id" id="book" class="inputBox" style="width: 100%; hight:100%">
                    <option selected>Buku Yang Dikembalikan</option>
                    @foreach ($books as $item)
                        <option value="{{ $item->id }}">{{$item->book_kode}}-{{ $item->title }}</option>
                    @endforeach
                </select>
            </div>
